...
export default function CreatePost() {
  ...
  async function handleSubmit(e) {
    ...
    if (!validate()) return;
    if (!user) {
      setMessage({ type: 'error', text: 'Você precisa estar logado para criar um post.' });
      return;
    }
    ...
    try {
      ...
      setMessage({ type: 'success', text: 'Post criado com sucesso! Redirecionando...' });
      setTimeout(() => navigate('/'), 1500);
    } catch (err) {
      setMessage({ type: 'error', text: 'Erro ao criar o post. Tente novamente.' });
      console.error(err);
    } finally {
      setSubmitting(false);
    }
    ...
    <main className="form-page">
      <div className="container">
        <div className="form-page-header animate-fadeIn">
          ...
          <h1 className="form-page-title">Criar Nova Postagem</h1>
          <p className="form-page-subtitle">Preencha os campos abaixo para publicar uma nova notícia</p>
        </div>
